...
if ( have_rows( 'steps' ) ) :
	?>
	<section class="section-steps" style="background-color: <?php echo get_field( 'section_colour' ); ?>" id="<?php echo $id; ?>" >
		<div class="container">
					...
					while ( have_rows( 'buttons' ) ) {
						...
						if ( $button_class ) {
							if ( $button_class == 'outline' ) {
								...
								$btn_class = 'btn-green';
							} elseif ( $button_class == 'white' ) {
								$btn_class = 'btn-white';
							} elseif ( $button_class == 'white-houtline' ) {
								$btn_class = 'btn-white-houtline';
							}
						}
						?>

...
?>
<section id="<?php echo $id; ?>" class="hero-banner <?php echo $className; ?> <?php echo $overlay; ?>" id=" <?php echo $id; ?> ">
    <div class="banner-bg">
		<?php echo wp_get_attachment_image( $banner_bg_image['id'], 'full' ); ?>
		<?php
			if($banner_bg_image_mobile) {
				echo wp_get_attachment_image( $banner_bg_image_mobile['id'], 'full', null, array("class"=>"img-mobile") );
			}
			else {
				echo wp_get_attachment_image( $banner_bg_image['id'], 'full', null, array("class"=>"img-mobile") );
			}
		?>
    </div>
    <div class="container">
